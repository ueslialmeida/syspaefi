...
caseDao.prototype.saveNewCase = function(caseInfo, callback) {
  ...
  this._connection.query(
    "INSERT INTO caso (id_usuario, numero_caso, violacao, nome_agressor, data_inclusao, encaminhamento, situacao, consequencias) VALUES((SELECT id FROM usuario WHERE nome = " +
      "'" +
      nomeUsuario +
      "'),'" +
      numeroProcesso +
