module.exports.addNewCase = function (application, req, res) {
  ...
  userDao.getUsers(function (error, result) {
    res.render('add_case_view', {
      pageTitle: 'Adicionar Novo Caso',
      validationError: {},
      caseInfo: {},
      users: result
    })
...
module.exports.editCase = function (application, req, res) {
  ...
  var caseObservationDao = new application.app.models.case_observation_dao(
    connection
  )
  var observations = {}
  ...
  caseDao.getCaseById(caseId, function (error, result) {
    res.render('edit_case_view', {
      pageTitle: 'Editar Informações do Caso',
      validationError: {},
      caseInfo: result,
...
module.exports.getOpenCases = function (application, req, res) {
  ...
  caseDao.getOpenCases(function (error, result) {
    res.render('cases_view', {
      pageTitle: 'Casos Cadastrados [ligados]',
      cases: result
    })
  })
}
...
module.exports.getCasesOnSearchByDate = function (application, req, res) {
  ...
  if (initialDate != '' && finalDate != '') {
    caseDao.getCaseByDate(column, initialDate, finalDate, function (
      error,
      result
    ) {
      res.render('cases_view', {
